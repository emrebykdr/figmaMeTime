...
class OnboardingChooseTypeMassage extends StatelessWidget {
  const OnboardingChooseTypeMassage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final services = [
      {'image': 'assets/choose_massage.jpg', 'title': 'Swedish Massage', 'price': '\$60'},
      {'image': 'assets/choose_massage.jpg', 'title': 'Deep Tissue Massage', 'price': '\$80'},
      {'image': 'assets/choose_massage.jpg', 'title': 'Hot Stone Massage', 'price': '\$90'},
      {'image': 'assets/choose_massage.jpg', 'title': 'Aromatherapy Massage', 'price': '\$75'},
    ];
