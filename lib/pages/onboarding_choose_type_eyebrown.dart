...
class OnboardingChooseTypeEyebrown extends StatelessWidget {
  const OnboardingChooseTypeEyebrown({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final services = [
      {'image': 'assets/choose_eyebrown.jpg', 'title': 'Eyebrow Shaping', 'price': '\$20'},
      {'image': 'assets/choose_eyebrown.jpg', 'title': 'Eyebrow Tinting', 'price': '\$25'},
      {'image': 'assets/choose_eyebrown.jpg', 'title': 'Eyebrow Lamination', 'price': '\$45'},
      {'image': 'assets/choose_eyebrown.jpg', 'title': 'Microblading', 'price': '\$150'},
    ];
